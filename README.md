...
![Version: 1.105.1-bb.0](https://img.shields.io/badge/Version-1.105.1--bb.0-informational?style=flat-square) ![AppVersion: 1.105.1](https://img.shields.io/badge/AppVersion-1.105.1-informational?style=flat-square)
...
| global.gmp.gmpProxy.image | string | `"gke.gcr.io/prometheus-engine/frontend:v0.4.1-gke.0"` |  |
...
| global.mimirProxy.image | string | `"nginxinc/nginx-unprivileged"` |  |
...
| global.advancedReports.reports[0].filters[0].property | string | `"cluster"` |  |
| global.advancedReports.reports[0].filters[0].value | string | `"cluster-one"` |  |
...
| oidc.rbac.groups[0].name | string | `"admin"` |  |
| oidc.rbac.groups[0].enabled | bool | `false` |  |
| oidc.rbac.groups[0].claimName | string | `"roles"` |  |
| oidc.rbac.groups[0].claimValues[0] | string | `"admin"` |  |
| oidc.rbac.groups[0].claimValues[1] | string | `"superusers"` |  |
| oidc.rbac.groups[1].name | string | `"readonly"` |  |
| oidc.rbac.groups[1].enabled | bool | `false` |  |
| oidc.rbac.groups[1].claimName | string | `"roles"` |  |
| oidc.rbac.groups[1].claimValues[0] | string | `"readonly"` |  |
| oidc.rbac.groups[2].name | string | `"editor"` |  |
| oidc.rbac.groups[2].enabled | bool | `false` |  |
| oidc.rbac.groups[2].claimName | string | `"roles"` |  |
| oidc.rbac.groups[2].claimValues[0] | string | `"editor"` |  |
...
| kubecostFrontend.livenessProbe.initialDelaySeconds | int | `30` |  |
...
| kubecostModel.cloudCost.enabled | bool | `true` |  |
...
| kubecostModel.livenessProbe.enabled | bool | `false` |  |
| kubecostModel.livenessProbe.initialDelaySeconds | int | `30` |  |
...
| remoteWrite.postgres.priorityClassName | string | `""` |  |
...
| networkCosts.image | string | `"gcr.io/kubecost1/kubecost-network-costs:v0.16.7"` |  |
...
| kubecostDeployment.queryServiceReplicas | int | `0` |  |
| kubecostDeployment.queryService.resources.requests.cpu | string | `"1000m"` |  |
| kubecostDeployment.queryService.resources.requests.memory | string | `"500Mi"` |  |
| kubecostDeployment.queryService.storageClass | string | `""` |  |
| kubecostDeployment.queryService.databaseVolumeSize | string | `"100Gi"` |  |
| kubecostDeployment.queryService.configVolumeSize | string | `"1Gi"` |  |
| clusterController.enabled | bool | `false` |  |
| clusterController.image | string | `"gcr.io/kubecost1/cluster-controller:v0.11.0"` |  |
...
| federatedETL.primaryCluster | bool | `false` |  |
| federatedETL.useExistingS3Config | bool | `false` |  |
| federatedETL.redirectS3Backup | bool | `false` |  |
| federatedETL.useMultiClusterDB | bool | `false` |  |
| federatedETL.federator.enabled | bool | `false` |  |
| federatedETL.federator.clusters | list | `[]` |  |
